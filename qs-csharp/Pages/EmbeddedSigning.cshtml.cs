...
namespace qs_csharp.Pages
{
    public class EmbeddedSigning : PageModel
    {
        ...
        private const string returnUrl = "http://mssweb03-prj/pocDocuSign/DSReturn";



        public EmbeddedSigning(IOptions<DocusignSettings> config)
        {
            this.config = config;
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            string signerName = config.Value.UserFullName;
            string signerEmail = config.Value.UserEmail;


            string docName = "World_Wide_Corp_lorem.pdf";
